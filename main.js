...
function my_keydown(e) {
    ...
    if (WDcar1_x > 700) {
        console.log("White Dragon Wins");
        document.getElementById("game_status").innerHTML = "White Dragon Wins!";
    }
    if (GMcar2_x > 700) {
        console.log("Green Machine Wins");
        document.getElementById("game_status").innerHTML = "Green Machine Wins!";
    }
}
